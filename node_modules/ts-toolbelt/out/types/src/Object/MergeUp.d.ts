...
declare type MergeUpDeep<O extends object, O1 extends object, OOK extends Index = OptionalKeys<O>, NOK extends Index = NullableKeys<O>> = O extends object ? O1 extends object ? ({
    [K in keyof (O & O1)]: And<Extends<Kind<NonNullable<At<O, K>>>, 'object'>, Extends<Kind<NonNullable<At<O1, K>>>, 'object'>> extends 1 ? MergeUpDeep<// the above makes sure it's only objects
    K extends NOK ? Optional<NonNullable<At<O, K>> & {}> : At<O, K> & {}, At<O1, K> & {}> | (K extends OOK ? never : Select<At<O, K>, undefined | null>) : MergeUpProp<O, O1, K, OOK>;
} & {}) : never : never;
